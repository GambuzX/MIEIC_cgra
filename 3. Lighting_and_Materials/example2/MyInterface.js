...
class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        this.gui.add(this.scene, 'ambientIntensity', 0.01, 1.0);//.onChange(this.scene.setGlobalAmbientLight(this.scene.ambientIntensity, this.scene.ambientIntensity, this.scene.ambientIntensity, 1.0));

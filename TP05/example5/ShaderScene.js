class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/yellow_blue_animation.vert", "shaders/yellow_blue.frag"),
			new CGFshader(this.gl, "shaders/yellow_blue.vert", "shaders/grayscale.frag"),
